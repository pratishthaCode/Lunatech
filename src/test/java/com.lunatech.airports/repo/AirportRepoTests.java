...
public class AirportRepoTests {
    ...
    public void testCountriesWithMostNumberOfAirports() {
        assertThat(repository.fetchCountriesMaxOfAirports()).containsSequence(302634L, 302708L);
    }

    @Test
    public void testCountriesWithLeastNumberOfAirports() {
        assertThat(repository.fetchCountriesMinOfAirports()).containsSequence(302708L, 302634L);
    }
